...
class ModelTraining:
    def __init__(self,data_path,params_path,model_save_path,experiment_name="Model Training Experiment"):
    ...
    def train_model(self,X_train,y_train, params):
        try:
            logger.info("Training model starting")
    ...
    def evaluate_model(self,X_test,y_test):
        try:
            ...
            raise CustomException("Error while evaluate model:", sys)
